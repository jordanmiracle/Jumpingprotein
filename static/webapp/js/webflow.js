...
!function (t) {
    ...
    var i = {}, r = {}, o = [], a = window.Webflow || [], s = window.jQuery, u = s(window), c = s(document),
        l = s.isFunction, h = i._ = n(4), f = i.tram = n(1) && s.tram, d = !1, p = !1;
    ...
    i.resize = z(u, k), i.scroll = z(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = z(), i.location = function (t) {
        ...
        d = !0, p ? (p = !1, h.each(r, v)) : h.each(o, S), h.each(a, S), i.resize.up()
    }, i.load = function (t) {
        _.then(t)
    }, i.destroy = function (t) {
        t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (d = t.domready), h.each(r, m), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === _.state() && E()
    ...
    window.tram = function (t) {
        ...
        var l = function (t, e, n) {
                ...
                return function i(s, u) {
                    ...
                    var h, f = a[t] = s[t], d = l[t] = c[t] = new a;
                    return d.constructor = c, c.mixin = function (e) {
                        return l[t] = c[t] = i(c, e)[t], c
                    }, c.open = function (t) {
                        if (h = {}, o(t) ? h = t.call(c, d, f, c, s) : r(t) && (h = t), r(h)) for (var n in h) e.call(h, n) && (d[n] = h[n]);
            ...
            }, d = document, p = window, v = "bkwld-tram", m = /[\-\.0-9]/g, w = /[A-Z]/, b = "number", g = /^(rgb|#)/,
            y = /(em|cm|mm|in|pt|pc|px)$/, x = /(em|cm|mm|in|pt|pc|px|%)$/, _ = /(deg|rad|turn)$/, k = "unitless",
            z = /(all|none) 0s ease 0s/, S = /^(width|height)$/, E = " ", M = d.createElement("a"),
            j = ["Webkit", "Moz", "O", "ms"], q = ["-webkit-", "-moz-", "-o-", "-ms-"], A = function (t) {
                if (t in M.style) return {dom: t, css: t};
                var e, n, i = "", r = t.split("-");
                for (e = 0; e < r.length; e++) i += r[e].charAt(0).toUpperCase() + r[e].slice(1);
                for (e = 0; e < j.length; e++) if ((n = j[e] + i) in M.style) return {dom: n, css: q[e] + t}
            }, $ = e.support = {
        ...
        if ($.transition) {
            var L = $.timing.dom;
            if (M.style[L] = h["ease-in-back"][0], !M.style[L]) for (var O in f) h[O][0] = f[O]
        }
        var F = e.frame = function () {
            ...
            e.init = function (e) {
                ...
                $.backface && X.hideBackface && G(this.el, $.backface.css, "hidden")
            ...
            function n() {
                ...
                if (r) for (F(n), e = T(), t = r; t--;) (i = u[t]) && i.render(e)
            }

            var i = {ease: h.ease[1], from: 0, to: 1};
            e.init = function (t) {
                ...
                var t;
                this.active || (this.start || (this.start = T()), this.active = !0, t = this, 1 === u.push(t) && F(n))
            }, e.stop = function () {
                var e, n, i;
        ...
        e.fallback = function (t) {
            if (!$.transition) return X.fallback = !0;
            X.agentTests.push("(" + t + ")");
        ...
        var G = t.style, Z = t.css, U = {transform: $.transform && $.transform.css}, Y = {
            color: [P, g],
        ...
        $.transform && (Y.transform = [D], K = {
            ...
            skewX: [_],
            skewY: [_]
        }), $.transform && $.backface && (K.z = [x, "translateZ"], K.rotateZ = [_], K.scaleZ = [b], K.perspective = [y]);
        var Q = /ms/, J = /s|\./;
        return t.tram = e
    }(window.jQuery)
}, function (t, e, n) {
    n(3), n(7), n(8), t.exports = n(9)
}, function (t, e, n) {
    "use strict";
    var i = n(0);
 ...
 */
    t.exports = function () {
        var t = {VERSION: "1.6.0-Webflow"}, e = {}, n = Array.prototype, i = Object.prototype, o = Function.prototype,
            ...
            l = (n.reduce, n.reduceRight, n.filter), h = (n.every, n.some), f = n.indexOf,
    ...
    i.define("links", t.exports = function (t, e) {
        var n, r, o, a = {}, s = t(window), u = i.env(), c = window.location, l = document.createElement("a"),
            h = "w--current", f = /index\.(html|php)$/, d = /\/$/;
    ...
    i.define("scroll", t.exports = function (t) {
        var e = {WF_CLICK_EMPTY: "click.wf-empty-link", WF_CLICK_SCROLL: "click.wf-scroll"}, n = window.location,
            ...
            }() ? null : window.history, o = t(window), a = t(document), s = t(document.body),
            ...
            l = "header, " + c + " > .header, " + c + " > .w-nav:not([data-no-scroll])", h = 'a[href="#"]',
            ...
            if (!(i.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(a.className))) {
                ...
                if ("" !== h) {
                    ...
                    f.length && (e && (e.preventDefault(), e.stopPropagation()), function (t) {
                        ...
                        !function (e) {
                            var n = o.scrollTop(), i = function (e) {
                                var n = t(l), i = "fixed" === n.css("position") ? n.outerHeight() : 0,
                                    r = e.offset().top - i;
                                if ("mid" === e.data("scroll")) {
                                    var a = o.height() - i, s = e.outerHeight();
        ...
        function i(e) {
            ...
            function c(e) {
                if (o) {
                    ...
                    }("swipe", e, {direction: c > 0 ? "right" : "left"}), h())
                }
            }
